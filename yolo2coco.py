...
# 自己的数据集有什么类别，就填什么，不知道的话，可以看看数据集的yaml文件
classes = ['A']

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default=r'E:\yolo\yolov11v12\datasets\demo\images\val2', type=str,
                    help="path of images")
parser.add_argument('--label_path', default=r'E:\yolo\yolov11v12\datasets\demo\labels\val', type=str,
                    help="path of labels .txt")
parser.add_argument('--save_path', default='COCO/data_val1.json', type=str,
                    help="if not split the dataset, give a path to a json file")

# parser.add_argument('--image_path', default=r'E:\yolo\ultralytics-main\yolov11\datasets\data\images', type=str,
#                     help="path of images")
# parser.add_argument('--label_path', default=r'E:\yolo\ultralytics-main\yolov11\datasets\data\labels', type=str,
#                     help="path of labels .txt")
