...
def get_params():
    params = {
        'weight': r'E:\yolo\yolov11v12\runs\V11train\exp26\weights\best.pt',  # 训练出来的权重文件
        'cfg': r'E:\yolo\yolov11v12\ultralytics\cfg\models\addv11\yolov11n_MGLFM.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
        'method': 'GradCAM',
        ...
        'conf_threshold': 0.2,  # 0.6  # 置信度阈值，有的时候你的进度条到一半就停止了就是因为没有高于此值的了
        'ratio': 0.02  # 0.02-0.1
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'E:\yolo\yolov11v12\datasets\data\images\train\000002.jpg', 'result/v11')  # 第一个是检测的文件, 第二个是保存的路径